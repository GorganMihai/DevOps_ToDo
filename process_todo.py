...
def invoke_image_processor(todo_data):
    ...
    try:
        ...
        # Get imageProcessor function name
        function_name = f"todo-serverless-service-{os.environ.get('STAGE', 'dev')}-imageProcessor"
        ...
        print(f"ImageProcessor invoked successfully (StatusCode: {response['StatusCode']})")
        return True
